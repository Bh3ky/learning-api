"""Testing SQLAlchemt Helper Functions"""
import pytest
...
# Decorator with a fixture used during the arrange phase to prepare the testing setup. 
@pytest.fixture(scope="function")  # Use of session scope to run once for each function. 
def db_session():
...
def test_get_player(db_session):
    """Test you can get the first player from the database."""
...
def test_get_all_performances(db_session):
    """Test that the count of performances in the database is
